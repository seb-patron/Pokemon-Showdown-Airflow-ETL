...
def reset_state(format_id: str) -> Dict[str, Any]:
    """
    Reset the state for a specific format, allowing it to fetch all replays from the beginning.
    
    Args:
        format_id: The format ID to reset state for
    ...
    save_state(new_state, format_id)
    logger.info(f"State for format {format_id} has been reset")
